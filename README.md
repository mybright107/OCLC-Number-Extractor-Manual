...
## Download
[Download OCLC Number Extractor v.1](https://github.com/mybright107/OCLC-Number-Extractor-Manual/releases/download/v.1/OCLC_Extractor.zip)

After downloading:
1. Extract the entire ZIP file.
2. Open the extracted `OCLC_Extractor` folder.
3. Double-click `OCLC_Extractor.exe`.
